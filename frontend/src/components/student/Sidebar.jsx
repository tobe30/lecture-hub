...
const sidebarLinks = [
  { name: "Dashboard", icon: LayoutDashboard, to: "/student" },
  { name: "My Classes", icon: BookOpen, to: "/student/classes" },
  { name: "Live Sessions", icon: VideoIcon, to: "/student/sessions" },
];
        ...
        <ul className="space-y-1.5">
          {sidebarLinks.map((item) => {
            const isActive =
              ...
              (item.to !== "/student" && location.pathname.startsWith(item.to));
